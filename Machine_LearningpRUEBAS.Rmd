...
Escalamos los datos. Antes hacemos una selección de las variables que son numéricas:
...
sando el modelo2, comparamos con el precio real calculando la diferencia entre ambos. Finalmente, hallamos la media de todas las diferencias y comprabamos que de media hay una diferencia de 133861.8$ aproximadamente. 
