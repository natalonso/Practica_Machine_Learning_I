...
En nuestro estudio inicial, la variable "Precio" es continua, por lo que vamos a categorizarla. Se va a probar lo siguiente:
...
En este mapa se puede visualizar cómo se distribuyen las casas "Caras" y "Baratas" en el mapa. Se observa que las casas que están cercanas al agua y a cerca de Seattle por la parte Norte, son más caras y hacia el sur más baratas.
