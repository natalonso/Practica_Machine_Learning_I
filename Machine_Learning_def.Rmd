...
par(mfrow=c(4,4))
plot(model_gam,all.terms=TRUE,scheme=1)
...
```{r}
datos_test_limpio$price <- datos_test
...
```{r}
datos_validacion_gam <- datos_validacion_limpio
datos_validacion_gam$price <- datos_validacion$price
```
