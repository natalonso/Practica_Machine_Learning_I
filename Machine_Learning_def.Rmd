...
# set.seed(1234)
# svm_tune <- tune("svm", price_categ1 ~., data = datos_train_limpio, kernel = 'radial', 
#                ranges = list(cost = c(0.01, 1, 10), gamma = c(0.5, 2, 4)))
...
plot(modelo_svm, 
     datos_train_limpio, 
     formula = log_sqft_living~bedrooms)
...
Los modelos GAM (Modelos Aditivos Generalizados) son una extensión de los modelos lineales que permiten obtener ajustes no lineales empleando múltiples predictores
...
"F_Medida_test" = c(NA,F_knn_test,F_dt_test,F_rf_test,F_svm_test),
"F_Medida_validacion" = c(NA,F_knn_validacion,F_dt_validacion,F_rf_validacion,F_svm_validacion))
models_cross
