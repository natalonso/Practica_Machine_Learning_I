...
```{r}
modelo_svm <- svm(formula = price_categ1 ~., data = datos_train_limpio_dt, kernel = "polynomial" ,scale = FALSE)
summary(modelo_svm)
...
tabla_svm_train=table(obs = datos_train_limpio_dt$price_categ1, pred = predict(modelo_svm,datos_train_limpio_dt[,-14], type ="class"))
...
tabla_svm_test=table(obs = datos_test_limpio$price_categ1, pred = predict(modelo_svm,datos_test_limpio[,c(-15,-16)], type ="class"))
tabla_svm_test
...
tabla_svm_val=table(obs = datos_validacion_limpio$price_categ1, pred = predict(modelo_svm,datos_validacion_limpio[,c(-15,-16)], type ="class"))
