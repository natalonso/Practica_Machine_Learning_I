...
datos_train_limpio <- datos_train[c(3,22:26,8:10,27,16,17,29,28,20,21)]
...
#ELIMINAMOS EL SEGUNDO GRÁFICO PORQUE YA LO HEMOS EXPLICADO CON EL MAPA DE ARRIBA CUANDO PINTAMOS LAS TRES CATEGORÍAS.


#colores2= c("red","blue","green")
#colores22 = colores2[datos_train_limpio$price_categ2]

#plot(prcomp(datos_train_numeric, scale = T)$x[,1:2], type="n",main= "Tres categorías" )
...
```{r}
decisiontree_model=rpart(price_categ1~., data=datos_train_limpio,parms=list(split="gini") )
...
tabla.train.arbol1=table(obs = datos_train_limpio$price_categ1, pred = predict(decisiontree_model, type = "class") )
