...
Como se concluye de las dos tablas anteriores, los diferentes clústeres agrupan observaciones con un número medio de habitaciones, y un log_sqft_living y log_lot con valores medios muy similares. De esto se concluye que la agrupación no está teniendo buenos resultados.
